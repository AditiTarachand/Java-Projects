...
{
     long random;
    JTextField nameTextField, fnameTextField,  emailTextField, addresTextField, cityTextField, staTextField, pinTextField;
    JButton  next;
    ...
    signup1(){
        ...
        Random ran= new Random();
         ...
         random=  Math.abs(ran.nextLong()% 9000L)+ 1000L;  //Math.abs krne se -ve value ko bhi +ve value kar dega
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        String formno=""+ random;  //formno long me hai, usko convert krna padhega String me.... ""+ isse krne se long to string convert hota hai
